  ...
  return (
    <div className='platform'>
      ...
      <div className='sub_block_3'>
        <div className='text_sub_block_3'>{text1}</div>
        <div className='img_sub_block_3'></div>
      </div>
      <div className='heading2_block_3'>Contribute to core</div>
      <div className='sub_heading2_block_3'>{subText}</div>
      <div className='sub_block_3 sub_block_margin'>
        <div className='text_sub_block_3'>{text2}</div>
        <div className='img_sub_block_3'></div>
      </div>
    </div>
  );
